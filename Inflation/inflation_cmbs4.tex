...
\begin{figure}[h]
\begin{center}
\includegraphics[width=4in]{Inflation/cmb_powspec.pdf}
\end{center}
...
Current measurements of the B-mode spectrum are shown for {Bicep}2/{\em Keck Array} (dark gray), POLARBEAR (orange), and SPTPol (purple). 
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=6in]{Inflation/nsrlabeledrp01v8s}
\end{center}
