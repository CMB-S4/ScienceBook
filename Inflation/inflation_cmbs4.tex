...
The larger-area survey will encompass
the cold spot and measure the $E$ modes there with high signal-to-noise ratio.
...
into $\ell$ space, which could be explored. Exploring this asymmetry
...
of the temperature-correlated part, is consistent with the expected level of temperature-uncorrelated E-mode fluctuations. Inconsistency would be evidence for a more interesting origin for the cold spot. The survey from Chile will include the cold spot
...
The Fisher projections for {\it Planck\/} around a fiducial model of $f_{10}=0.01$ are $f_{10}<0.032$. This corresponds to $G\mu < 3.5\times 10^{-7}$ at $95\%$~CL, is consistent with the {\it Planck\/} constraints on the AH-mimic spectra.
