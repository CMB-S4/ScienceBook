...
\begin{table*}[t]
  \begin{center}
    \begin{tabular}{ | c || c | c | c | c |}
      ...
      Local & $\sigma(f_{\rm NL}) = 5\, (4.6)$ & $\sigma(f_{\rm NL}) = 2.8$ &  $\sigma(f_{\rm NL}) = 1.9$ & 2.4\\ \hline 
      Equilateral &  $\sigma(f_{\rm NL}) = 43\,(40.4)$ & $\sigma(f_{\rm NL}) = 18.8$ &  $\sigma(f_{\rm NL}) = 15.4$ & 2.6\\ \hline 
      Orthogonal &  $\sigma(f_{\rm NL}) = 21\, (20.2)$ & $\sigma(f_{\rm NL}) = 8.7$ &  $\sigma(f_{\rm NL}) = 8.5$ & 2.4\\ \hline 
      Flat &  $\sigma(f_{\rm NL}) = 37\, (34.9)$ & $\sigma(f_{\rm NL}) = 15.2$ &  $\sigma(f_{\rm NL}) = 15.2$ & 1.7\\ \hline 
    \end{tabular}
  \end{center}
