...
\begin{align}
S_{i \gamma}\equiv \frac{\delta n_{i}}{n_{i}}-\frac{\delta n_{\gamma}}{n_{\gamma}} =0,\end{align} where $i$ is a species label and can denote isocurvature in baryons, cold dark matter, or neutrinos. The number densities of the $i^{\rm th}$ species are denoted by $n_{i},$ and $\delta n_{i}$ denotes the spatial perturbation in the $i^{\rm th}$ species.
