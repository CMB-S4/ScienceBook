...
%(Non-Gaussianity in just the scalar sector, $\langle \zeta(\mathbf{k}_1)\zeta(\mathbf{k}_2)\zeta(\mathbf{k}_3) \rangle$, is discussed in Section \ref{subsec:scalarNG}.) 
...
%As shown in Eq.~(\ref{eq:Bsst}), the bispectrum is a nearly arbitrary function of three momenta, subject only to the constraint $\mathbf{k}_1+\mathbf{k}_2+\mathbf{k}_3=0$ from translation invariance. 
