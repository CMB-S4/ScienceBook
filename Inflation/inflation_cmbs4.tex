...
\begin{table*}[t]
  \begin{center}
    \begin{tabular}{ | c || c | c | c | c |}
      ...
      Local & $\sigma(f_{\rm NL}) = 5\, (3.1)$ & $\sigma(f_{\rm NL}) = 2.8$ &  $\sigma(f_{\rm NL}) = 1.8$ & 1.7\\ \hline 
      Equilateral &  $\sigma(f_{\rm NL}) = 43\,(32.1)$ & $\sigma(f_{\rm NL}) = 18.8$ &  $\sigma(f_{\rm NL}) = 18.8$ & 1.7\\ \hline 
      Orthogonal &  $\sigma(f_{\rm NL}) = 21\, (15.4)$ & $\sigma(f_{\rm NL}) = 8.7$ &  $\sigma(f_{\rm NL}) = 8.7$ & 1.8\\ \hline 
      Flat &  $\sigma(f_{\rm NL}) = 37\, (26.1)$ & $\sigma(f_{\rm NL}) = 15.2$ &  $\sigma(f_{\rm NL}) = 15.2$ & 1.7\\ \hline 
    \end{tabular}
  \end{center}
