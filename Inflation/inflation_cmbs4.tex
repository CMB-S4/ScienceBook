...
%The lowest-order correlation function that encodes departures from Gaussianity is the 3-point function
%\begin{equation}
...
%\end{equation}
%where the delta function comes from translation invariance. In many scenarios invariance under rotations and translations guarantees that the bispectrum $B_{\zeta}(k_1,k_2,k_3)$ only depends on the magnitudes $k_1$, $k_2$, and $k_3$. 
