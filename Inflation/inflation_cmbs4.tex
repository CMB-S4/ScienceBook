...
Current measurements of the B-mode spectrum are shown for {\sc Bicep}2/Keck Array (dark gray), POLARBEAR (orange), and SPT (purple). 
...
To account for real-world inefficiencies, including non-ideal detector performance and yield, observing efficiency, bad weather, data filtering, and cuts, the forecasts in this section use scaled versions of achieved power-spectrum covariance matrices from the BICEP2/Keck experiments.
...
The boxes denote the forecasted S4 erorr bars.  
