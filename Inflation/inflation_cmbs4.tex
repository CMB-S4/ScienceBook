...
values, deviate slightly from the actual bounds on non-Gaussianities obtained in Ref.~\cite{Ade:2015ava}. The expected factor of improvement over {\it Planck}-only is somewhere between 2.3 and 2.7 for all shapes considered. Information saturates beyond $\ell_{\rm max} = 4000$ for all shapes for an experiment with a $1^\prime$ beam. 
...
\begin{table*}[t]
  \begin{center}
    \begin{tabular}{ | c || c | c | c | c |}
      ...
      Flat &  $\sigma(f_{\rm NL}) = 37\, (34.9)$ & $\sigma(f_{\rm NL}) = 15.5$ &  $\sigma(f_{\rm NL}) = 15.4$ & 2.3\\ \hline 
    \end{tabular}
  \end{center}
