...
If a detection of primordial gravitational waves is made with CMB S4, the next step is to understand the possible sources of the signal. The spectrum of B-modes from vacuum fluctuations of the metric, amplified by inflation, is nearly scale-invariant and very nearly Gaussian. Any deviation from these features would be an indication of a richer inflationary sector, or possibly even of non-inflationary primordial physics. In this section we discuss how well CMB S4, given a detection, could characterize the B-mode spectrum and test for contributions from non-vacuum sources during inflation, or cosmic strings or phase transitions after inflation. It is important to note that as long as the contribution from non-vacuum sources is not orders of magnitude larger than the vacuum contribution, the determination of the energy scale of inflation is not significantly affected. We also comment on some of the physics in higher order tensor and tensor/scalar correlations, although this is likely out of reach of CMB S4, and discuss the status of alternatives to inflation.   
%They may also test physics beyond Einstein gravity with matter minimally coupled to gravity.  
