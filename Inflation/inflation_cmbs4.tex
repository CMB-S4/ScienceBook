...
(see, e.g.\ Refs.~\cite{Bennett2011,Planck2015XVI} and \cite{Schwarz2015} for
...
promising way of probing these anomalies.
...
measure the B-mode recombination bump will probe relevant E-modes, and do so
...
spectrum in $k$, then there should in fact be a slightly different projection
into $\ell$ space.  For the cold spot, if it is simply a large fluctuation
...
for a more interesting origin of the cold spot.
