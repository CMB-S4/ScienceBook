...
%**** v1\\
%Questions about the origin of the Universe and the structures in it have fascinated mankind for millennia. Progress towards answering them has only recently become possible, and observations of the fluctuations in the temperature and polarization of the cosmic microwave background have revealed that all structures originated from primordial density perturbations that were laid down in the first fraction of a second of the history of our Universe. With CMB-S4 we will take the next step and begin to answer questions about the physical processes that created the primordial density perturbations that grew into the temperature anisotropies in the cosmic microwave background and eventually into the stars and galaxies we see around us. 

%The leading paradigm for explaining the origin of the primordial density perturbations is inflation, a period of accelerated expansion of the Universe. In addition to primordial density perturbations, the rapid expansion creates primordial gravitational waves which imprint a characteristic polarization pattern onto the cosmic microwave background. If our Universe is described by a typical model of inflation that naturally explains the statistical properties of the density perturbations, CMB-S4 will detect this signature of inflation. A detection of this polarization pattern would provide us with an additional relic left over from the big bang and would open a completely new window onto the early Universe. This new relic would be much less affected by late time physics than density perturbations and abundances of light elements produced in the big bang, and would transform our understanding of several aspects of fundamental physics. Because the polarization pattern is due to quantum fluctuations in the gravitational field during inflation, it would provide insights into the quantum nature of gravity. The strength of the signal, encoded in the tensor-to-scalar ratio $r$, would provide a direct measurement of the expansion rate of the universe during inflation. A detection with CMB-S4 would point to inflationary physics near the energy scale associated with grand unified theories and would provide additional evidence in favor of the idea of the unification of forces. It would also have important implications for many other aspects of fundamental physics, for example for axions and moduli, which are ubiquitous ingredients in string theory.

%Even an upper limit of $r<0.001$ achievable by CMB-S4, almost two orders of magnitude stronger than current limits, would be extremely interesting. It would rule out the most popular and most widely studied classes of inflation models and would dramatically impact how we think about the theory. To some, the remaining class of models would be contrived enough to give up on inflation altogether. Furthermore, CMB-S4 is in a unique position to probe the statistical properties of density perturbations over the entire range of scales that can be probed through measurements of primary anisotropies in the temperature and polarization of the cosmic microwave background and with unprecedented precision, and will provide invaluable information about the early Universe.

%**** v2\\
Inflation, a period of accelerated expansion of the Universe, is the leading paradigm for explaining the origin of the primordial density perturbations that grew into the temperature anisotropies in the cosmic microwave background and eventually into the stars and galaxies we see around us. In addition to primordial density perturbations, the rapid expansion creates primordial gravitational waves which imprint a characteristic polarization pattern onto the cosmic microwave background. If our Universe is described by a typical model of inflation that naturally explains the statistical properties of the density perturbations, CMB-S4 will detect this signature of inflation. A detection of this polarization pattern would open a completely new window onto the physics of the early Universe and provide us with an additional relic left over from the hot big bang. This relic would constitute our most direct probe of the very early Universe and would transform our understanding of several aspects of fundamental physics. Because the polarization pattern is due to quantum fluctuations in the gravitational field during inflation, it would provide insights into the quantum nature of gravity. The strength of the signal, encoded in the tensor-to-scalar ratio $r$, would provide a direct measurement of the expansion rate of the Universe during inflation. A detection with CMB-S4 would point to inflationary physics near the energy scale associated with grand unified theories and would provide additional evidence in favor of the idea of the unification of forces. It would also have important implications for many other aspects of fundamental physics, for example, axions and moduli, which are ubiquitous ingredients in string theory.


Even an upper limit of $r<0.001$ achievable by CMB-S4, almost two orders of magnitude stronger than current limits, would be extremely interesting. It would rule out the most popular and most widely studied classes of inflation models and would dramatically impact how we think about the theory. To some, the remaining class of models would be contrived enough to give up on inflation altogether. Furthermore, CMB-S4 is in a unique position to probe the statistical properties of density perturbations over the entire range of scales that can be probed through measurements of primary anisotropies in the temperature and polarization of the cosmic microwave background and with unprecedented precision, and will provide invaluable information about the early Universe.

%**** v3\\
%Inflation, a period of accelerated expansion of the universe, is the leading paradigm for explaining the origin of primordial perturbations, the seeds that grew into the temperature anisotropies in the cosmic microwave background and eventually into the stars and galaxies we see around us. The paradigm predicts density perturbations with a strength that is nearly independent of scale over many orders of magnitude. Such nearly scale-invariant density perturbations have now been observed over 7 $e$-folds, and a small departure from scale-invariance, just as predicted by inflation, has been detected. CMB-S4 will measure the density perturbations over the entire range of scales that can be probed through measurements of primary anisotropies of the cosmic microwave background and will extend the range of scales by another $e$-fold. This will either provide additional support for inflation or rule out the basic paradigm. 

%More importantly, many models of inflation that naturally explain the sign and magnitude of the observed departure from scale invariance in the strength of the density perturbations predict that the expansion of the universe at these early times was so rapid that primordial gravitational waves imprinted a polarization pattern onto the cosmic microwave background that is strong enough to be detected with CMB-S4. A detection of this B-mode polarization pattern would open a new window onto the physical processes of the early universe, one that is much less affected by late time physics than both the density perturbations that have taught us so much as well as the abundances of light elements produced in the big bang. A detection with CMB-S4 would transform our understanding of fundamental physics. The observation of quantum fluctuations of the spacetime metric would present the first experimental evidence for quantum gravity. The strength of the signal, encoded in the tensor-to-scalar ratio $r$, would provide a measurement of the expansion rate of the universe during inflation. Regardless of the strength, a detection would provide evidence for a Planckian excursion of the inflaton in field space, which has important implications for theories of quantum gravity. A detection with CMB-S4 would point to the energy scale associated with grand unified theories and would provide additional evidence in favor of the idea of the unification of forces. It would also have important implications for axions and moduli, ubiquitous ingredients in string theory. Even the upper limit of $r<0.001$ achievable by CMB-S4 would be extremely interesting. It would rule out the most popular and most widely studied models of inflation and would dramatically impact how we think about inflation. To some, the remaining models would be contrived enough to give up on inflation altogether. 
...
As we explain in what follows, if CMB-S4 does {\it not\/} detect primordial $B$ modes, only class II with $\mathcal{N}_{\rm eq}\lesssim 1$ will remain viable,
...
%(Non-Gaussianity in just the scalar sector, $\langle \zeta(\vec{k}_1)\zeta(\vec{k}_2)\zeta(\vec{k}_3) \rangle$, is discussed in Section \ref{subsec:scalarNG}.) 

The details of the tensor-scalar-scalar correlator are contained in the bispectrum $B_{\zeta\zeta\gamma_\sigma}(\vec{k}_1,\vec{k}_2,\vec{k}_3)$, defined by pulling out the appropriate polarization structure associated with the tensor mode:
\begin{equation}
\label{eq:Bsst}
\qquad \langle \zeta(\vec{k}_1)\zeta(\vec{k}_2)\gamma_\sigma(\vec{k}_3) \rangle = (2\pi)^3 \delta(\vec{k}_1+\vec{k}_2+\vec{k}_3) B_{\zeta\zeta\gamma_\sigma}(k_1,k_2,k_3) e_{ij}(\vec{k}_3,\sigma)\hat{k}_1^i \hat{k}_2^j,
\end{equation}
where $e_{ij}(\vec{k},\sigma)$ is the transverse-traceless polarization tensor.  
%As shown in Eq.~(\ref{eq:Bsst}), the bispectrum is a nearly arbitrary function of three momenta, subject only to the constraint $\vec{k}_1+\vec{k}_2+\vec{k}_3=0$ from translation invariance. 
...
%
%The amplitude of the 3-point correlations between tensors alone (in both standard inflation and most extensions) is small, at most $f^{\rm tensor}_{\rm NL}\lesssim 1$ \cite{Maldacena:2002vr,Maldacena:2011nz}. So while any constraint on the gravitational 3-point function would be a useful data point for secondary sources, it is unlikely to be significant for vacuum fluctuations. There are however a few possibilities to produce larger effects: different symmetry patterns (e.g. solid inflation \cite{Endlich:2012pz} or gauge-flation \cite{Maleknejad:2011jw}); GWs not produced as vacuum fluctuations; or multiple tensors (e.g.\ bigravity) \cite{Bordin:2016ruc}. A detection would therefore constitute a clear signature of new physics of some sort. Any non-zero tensor amplitude could also be sourced by a higher-order massive spin field that couples to two scalars and one graviton \cite{Dimastrogiovanni:2015pla}. From an observational point of view, such interactions are interesting to constrain using correlators that couple one $B$ field with a combination of two $E$ and $T$ modes. No constraint on this type of non-Gaussianity currently exists, and CMB-S4 is projected to improve bounds on graviton interactions by two orders of magnitude \cite{Meerburg:2016ecv} compared to {\it Planck}.  

Table~\ref{tab:fnl_forecast2} shows that the level of non-Gaussiianty predicted by the simplest models of inflation is out of reach. A detection of this correlation would be an immediate indication of some deviation from the simple inflationary paradigm \cite{Bordin:2016ruc,Dimastrogiovanni:2015pla}. There are a few known possibilities that would generate a scalar-scalar-tensor bispectrum with larger amplitude and/or different shape: different symmetry patterns (e.g. solid inflation \cite{Endlich:2012pz} or gauge-flation \cite{Maleknejad:2011jw, Adshead:2016iix}); GWs not produced as vacuum fluctuations; or multiple tensors (e.g.\ bigravity) \cite{Bordin:2016ruc}. Any non-zero tensor amplitude could also be sourced by a higher-order massive spin field that couples to two scalars and one graviton \cite{Dimastrogiovanni:2015pla}. A detection would therefore constitute a clear signature of new physics of some sort. Finally, it is worth noting that, if primordial gravitational waves were indeed chiral, they may present themselves first through a non-vanishing cross-correlation of B modes with temperature, as demonstrated in Ref.~\cite{Contaldi:2008yz}.
...
\end{equation}
The structure of particle interactions relevant for inflation provides both a general organizing principle for this functional space and several specific, well motivated forms of the bispectrum $B_{\zeta}(\vec{k}_1,\vec{k}_2,\vec{k}_3)$ that can be explicitly compared to data. Here we briefly review the classification of scalar non-Gaussianity from inflation and then present forecasts for improvements from CMB-S4 on a few of the standard bispectral templates. We also comment on non-Gaussian signatures that are especially relevant for large-field inflation.
...
tell us about fundamental physics, for example about the nature of inflation.
...
be predicted from the temperature profile, and hence one can test whether that
is consistent with the measured E-mode map; if not, then it would be evidence
for a more interesting origin for the cold spot.
