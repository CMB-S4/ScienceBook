...
In this section, we introduce the basic concepts of cosmological inflation. We do this in two stages, first giving a broad outline of the important concepts then proceeding to a more technical definition.  Rather than surveying the extensive historical literature, we refer the reader to several review articles for further information
...
%The answer to that question is not as clear. For inflation to be displaced from its current status, among the large majority of cosmologists, as the most likely scenario for structure formation, we might need not only new Ade:2015tvaobservational data, which is inconsistent with the simplest models of inflation, but also new observational data that is compellingly explained by some alternative to inflation. 
