...
Constraints on non-Guassianity are often expressed in terms of the correlator of three scalar modes, described by the bispectrum $B_{\zeta}(\mathbf{k}_1,\mathbf{k}_2,\mathbf{k}_3)$, defined by
\begin{equation}
\label{eq:Bsss}
