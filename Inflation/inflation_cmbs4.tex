...
where the factor of $1/2$ in the second to last line accounts for the fact that the measured power includes (presumably equal) contributions from each of the two graviton polarizations. 
