...
\caption{Forecasts for $\sigma(\Neff)$ with varying beamize in arcmin and temperature noise.  These forecasts assume $f_{\rm sky} = 0.4$.  The color scale is the same for both panels.  {\bf Left:} Specific forecasts, including delensing, for various CMB-S4 configurations. {\bf Right:} A wide range of beam sizes and sensitivities are used to show the need for the high resolution and sensitivity of CMB-S4 to be close to our thresholds.  }
\label{fig:Neffbeam}
\end{center}
\end{figure} 
