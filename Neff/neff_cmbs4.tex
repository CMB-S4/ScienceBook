...
\begin{figure}[t!]
\begin{center}
\includegraphics[height=6.5cm]{Neff/Neff_heatmap.pdf} \hskip 0.25cm 
\includegraphics[height=6.5cm]{Neff/Neff_grid.pdf}
\caption{Forecasts for $\sigma(\Neff)$ with varying beamize in arcmin (') and detector sensitivity.  These forecasts assume $f_{\rm sky} = 0.4$.  {\it Left:} A wide range of beam sizes and sensitivities are used to show the need for the high resolution and sensitivity of CMB-S4 to be close to our thresholds.  {\it Right:} Specific forecasts, including delensing, for various CMB-S4 configurations.}
\label{fig:Neffbeam}
\end{center}
\end{figure} 
