...
Another advance of CMB Stage IV will be a fairly high precision {\it independent} measurement of primordial helium, $Y_p$ and $\Neff$. These two quantities probe neutrino and BSM physics in related, but different ways, allowing even finer probes of BSM physics, especially in the neutrino sector.  In particular, helium gives an integrated measure of this expansion rate convolved with the weak interaction rates that interconvert neutrons and protons. Helium therefore gives us a handle on neutrino energy distribution functions in a way that which $\Neff$ alone does not.  Furthermore, $Y_p$ and $\Neff$ probe the density of radiation at well separated times, a few minutes and 380 000 years respectively, which provides a window non-trivial evolution in the energy density of radiation.  
