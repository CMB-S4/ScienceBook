...
The capability of CMB-S4 to address its science program depends crucially on the ability to separate the signals of interest from other sources of astrophysical emission. Furthermore, the final accuracy of CMB-S4 parameter constraints will be limited by the accuracy of the characterization of foreground residuals after such cleaning is performed. 
...
%(including possible surprises) are above the sensitivity objectives of CMB-S4, 
must be modeled and treated for CMB-S4 or can be safely neglected;
