...
and 
the predicted small departure from pure scale invariance of the primordial fluctuations detected at 5-sigma confidence. Also of interest to particle physics, the effective number of light relativistic species (i.e., neutrinos and any yet identified ``dark radiation") is shown to be within 15\% of $\neff = 3.046$, the number predicted by BBN.  The sum of the masses of the neutrinos is found to be less than 0.6 eV. Dark matter is shown to be non-baryonic at $> 40$ sigma. Early dark energy models are highly constrained as are models of decaying dark matter. 
...
The Stage 2 and 3 experiments are logical technical and scientific stepping stones to CMB-S4. Ongoing R\&D directed toward achieving the scaling up required to CMB-S4 is being pursued at several universities and national labs. The  Simons Observatory will help develop the Chilean site for CMB-S4 and also contribute to CMB-S4 R\&D. Fig.~\ref{fig:science_timeline-intro} shows the timeline of the CMB sensitivity and the expected improvement in a few of the key cosmological parameters. The enormous jump in sensitivity with the corresponding improvement in science reach is clear.
...
\caption{Schematic chart showing how the scientific findings (yellow), the technical advances (blue) and satellite selections (green) would effect the science goals, survey strategy and possibly the design of CMB-S4 (green boxes)}
\label{fig:flowchart}
\end{figure}
