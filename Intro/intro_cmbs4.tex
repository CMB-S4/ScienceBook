...
the departure from pure scale invariance of the primordial fluctuations detected at 5 sigma confidence. Also of interest to particle physics, the effective number of light relativistic species (i.e., neutrinos and any yet identified ``dark radiation") is shown to be within one sigma of $\neff = 3.046$, the number predicted by BBN.  The sum of the masses of the neutrinos is found to be less than 0.6 eV. Dark matter is shown to be non-baryonic matter at $> 40$ sigma. Early dark energy models are highly constrained as are models of decaying dark matter. 
