...
%The purpose of this book is to set the scientific goals for CMB-S4 and the measurements required to achieve them, which will in turn determine the instrument definition.   This is of course an iterative process, involving detailed simulations and cost considerations. So, at this time the Science Book is a working document with this first edition focused primarily on defining the possible science reach in several areas, along with the simulations needed to refine the science case and set the specifications of the needed measurements. This will set the stage for defining the instrument. % and in the next iteration of the Science Book. 
%
...
%The Simons Observatory will help develop the Chilean site for CMB-S4 and also contribute to CMB-S4 R\&D. 
