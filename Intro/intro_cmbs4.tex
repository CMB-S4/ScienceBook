...
\item{Dark Energy, Dark Matter and Gravity:
 ...
 d) CMB-S4 will allow us to probe the dark sector with unprecedented accuracy.  Through their signatures of annihilation, CMB-S4 will be able to place constraints on Standard Model WIMPs around a few hundred GeV, and place limits on other types of DM interactions. In addition, CMB-S4 will place exquiste, percent-level bounds on potential ultra light scalar field DM candidates, such as ultralight axions, leveraging the complementarity of the CMB to other direct and indirect probes of dark matter.
 }
