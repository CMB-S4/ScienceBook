...
\begin{table}[t]\label{tab:string_forecast}
  \begin{center}
    \begin{tabular}{ | c || c | c |}
      \hline
       Model & Planck & CMB-S4 (1' resolution)  \\ \hline \hline
       Fixed $\alpha_\mathrm{str}:$ & $\sigma(f_{10})= 0.015$ & $\sigma(f_{10})=1.0563e-03$  \\ \hline
       Varying $\alpha_\mathrm{str}:$ & $\sigma(f_{10})= 0.017$ & $\sigma(f_{10})=1.8522e-033$ \\
        & $\sigma(\alpha_\mathrm{str})= 5.55$ & $\sigma(\alpha_\mathrm{str})=6.3902e-01$ \\
    \end{tabular}
  \end{center}
