...
\hline 
Axions & $\geq 0.027$  & Casper or ADMX detect axions & axions are the DM; lower-limit on the reheat temperature
\\  
Low-reheating & $0$  & Casper or ADMX detect axions & axions are the DM; upper-limit on the reheat temperature
\\  
Gravitinos & $\geq 0.057$  & LHC evidence for SUSY & upper limit on scale of SUSY breaking
\\  
Late Decays & $< 0$  & Spectra Distortions observed in CMB & evidence for new massive particle; energy injection
\\ 
Evolving $\Neff$ & $> 0$  & BBN abundance consistent with $\Delta \Neff =0$ & Radiation density changed between BBN and Recombination
\\  
Dark Sectors & $\geq 0.027 $  & None & New light particles; very weakling coupled to the SM
\\  
\hline 
\end{tabular}
