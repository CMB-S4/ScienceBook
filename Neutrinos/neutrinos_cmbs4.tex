...
\eeq
where $F'_{\mu \nu}$ is the field strength of $A'_\mu$.  We have included the higgs field, $H$, in the coupling to Standard model fermions as it is required by gauge invariance above the scale of electroweak symmetry breaking.  
