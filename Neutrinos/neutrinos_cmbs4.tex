...
\begin{tabular}{l ccc} 
 \toprule
    		$\sigma(\Neff)/\sigma(Y_p)$		    			& $1'$  		& $2'$  		& $3'$  		 \\ [0.5ex]
 \midrule
  ...
  2  $\mu$K-arcmin & 0.093 / 0.0054		& 0.096 / 0.0056		& 0.10 / 0.0058	 		  \\
   3  $\mu$K-arcmin & 0.10 / 0.0058		& 0.10 / 0.0059		& 0.11 / 0.0062		 		  \\
    \bottomrule
\end{tabular}
\caption{Forecasts for $\sigma(\Neff)$ and $\sigma(Y_p)$ with varying beamize in arcmin (') and detector sensitivity. These forecasts allow both $Y_p$ and $\Neff$ to vary (along with the parameters of $\Lambda$CDM).  We assume $f_{\rm sky} = 0.4$. }
