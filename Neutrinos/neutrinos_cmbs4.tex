...
\item $\Neff =  3.045$ and $Y_p \approx 0.2311 + 0.9502 \, \Omega_b h^2$ are predicted by standard neutrino decoupling and big bang nucleosynethesis (BBN).  $\Neff$ is a measure of the total energy density in neutrinos at recombination while $Y_p$ is a measures the neutrino distribution at BBN. 
\end{itemize}
