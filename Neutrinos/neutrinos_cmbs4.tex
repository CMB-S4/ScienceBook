...
The abundance of clusters with mass $M$ can be expressed by (e.g. \cite{Tinker:2008ff,Bhattacharya:2010wy}), 
\beq
\label{eq:clmfcn}
...
\subsubsection{CMB in Combination with Other Datasets}
...
\textcolor{red}{(DG:  Forward Reference to BSM chapter?)}
