...
Small-scale stage three CMB probes may themselves provide a window into improving the current $\tau$ bounds. As discussed in \cite{Calabrese:2014gwa, Galli:2014kla} the $EE$ polarisation spectrum will soon allow one to remove the CMB as `foreground' from temperature measurements and yield a multi-$\sigma$ detection of the kSZ effect, thereby improving our constraint on the optical depth because of the relationship between $\tau$ and the amplitude of the $kSZ$ spectrum. 
%
