...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{DarkEnergy/DM_annihilation_CMBS4.png}
...
The dashed/dotted lines show the limit from Planck (it was expected from Fisher forecasts and then confirmed by the Planck collaboration measurements), for a thermal cross section and $100\%$ of the energy absorbed by the plasma.}\label{fig:DM_annihilation}
\end{figure}
