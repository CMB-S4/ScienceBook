...
the gravitational slip or effective anisotropic stress  (the ratio of the space curvature potential and Newtonian potentials),  the effective Newton constant, and  $c_T$ the
...
of cosmic acceleration \cite{Gubitosi:2012hu,Bloomfield:2012ff}, inspired by the effective field theory for inflation described in the Inflation Chapter~\cite{Creminelli:2006xe,Cheung:2007st,Weinberg:2008hq,Creminelli:2008wc,Park:2010cw,Jimenez:2011nn}.    The EFT of cosmic acceleration describes the cosmological phenomenology of all universally coupled single scalar field dark energy and modified gravity models. Specifically, the EFT action is written in a unitary gauge that preserves isotropy and homogeneity of the cosmological background and reads:
%
...
Figure \ref{fig:limits} shows an estimate of the mass sensitivity, expressed as the one-sigma mass uncertainty as a function of redshift, for two possible S4 configurations and compares them to planned CMB experiments. 
