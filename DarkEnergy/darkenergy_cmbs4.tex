...
CMB-S4 will lower the mass threshold and provide an over an order of magnitude larger 
catalogs compared with completed and ongoing CMB surveys (see Fig.~\ref{fig:cluster_counts}).
