...
{\bf MR: shall we discuss here forecast specifications?}

\subsubsection{Trigger}

We consider the growth index $\gamma_{L}$, $\sigma_8(z)$ and $H(z)$ as trigger parameters. The central panel of Figure \ref{fig:MixedDEG} shows the marginal forecast constraint on $\gamma_{L}$. Figure \ref{fig:GrowthExpansion} shows the relative error on $\sigma_8(z)$ and $H(z)$, assuming an underlying $\Lambda$CDM model.
