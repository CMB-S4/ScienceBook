...
We consider axions within a range of masses $10^{-33}~\mathrm{eV}\leq m_{a}\leq 10^{-20}~\mathrm{eV}$ but not assume any particular coupling to the Standard model particles.  We can compare these assumptions to the hot axion populations considered Section~\ref{sec:neffaxions}; the contribution of thermal axions to $\Neff$ applies to any mass $m_{a}\lesssim 1~\mathrm{eV}$, including the well known QCD axion, but depend in detail on the couplings to the Standard Model and the reheat temperature.  In this sense, cosmological constraints on axion dark matter are orthogonal (complimentary) in the space of masses and couplings to the constraints on a thermal population of axions.
