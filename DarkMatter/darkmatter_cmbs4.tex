...
%
\section{Non-standard Dark Matter Interactions}
%
...
\section{Summary}
Determining the nature of dark matter remains one of the main goals of the current cosmological epoch. CMB-S4 will provide not only a handle on distinguishing between different models of DM annihilation and non-standard modes of DM interaction, but will also place extremely tight constraints on axions and axion-like particles. This will allow CMB-S4 to probe the dark sector and reduce the boundary of ignorance on this important cosmological component.
