...
The dashed/dotted lines show the limit from Planck for a thermal cross section and $20\%$ of the energy absorbed by the plasma (it was expected from Fisher forecasts for Planck nominal sensitivity).}\label{fig:DM_annihilation}
\end{center}
\end{figure}
