...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{CMBLensing/mnuS4errors.pdf}
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.75\textwidth]{CMBLensing/HaloLens.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{CMBLensing/delensPlot.pdf}
\vspace{0.3cm}
...
have been shown to impact non-negligibly on quadratic estimators for lensing extraction (Fantaye et al. 2012). %\cite{2012JCAP...12..017F}. 
...
Therefore, as was the case for the Planck data analysis %\cite{planck15-15}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{CMBLensing/Neff_Mnu.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{CMBLensing/sigma-r.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{CMBLensing/Das_confEllipse_omL_w_1sigma.png}
