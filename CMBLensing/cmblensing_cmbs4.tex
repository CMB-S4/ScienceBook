...
%% Colored comments for individual authors
\newcommand\kscomment[1]{\textcolor[rgb]{0,0.7,0}{{\bf KTS:} #1}}
\newcommand\kstext[1]{\textcolor[rgb]{0,0.7,0}{#1}}
\newcommand\avecomment[1]{\textcolor[rgb]{0,0,0.7}{{\bf AVE:} #1}}
\newcommand\avetext[1]{\textcolor[rgb]{0,0,0.7}{#1}}
