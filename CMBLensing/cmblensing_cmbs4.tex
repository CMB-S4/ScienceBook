...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{CMBLensing/CMB_effs.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.70\textwidth]{CMBLensing/cmb_powspec_for_s4scibooklensing.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{CMBLensing/delensPlot.pdf}
\vspace{0.3cm}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{CMBLensing/Neff_Mnu.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{CMBLensing/sigma-r.png}
