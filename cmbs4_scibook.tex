...
Through several workshops and numerous telecons, the CMB experimental groups, the broader cosmology community and the DOE HEP cosmic frontier community came together to produce two influential planning papers, title, title, 
\cite{snowmass_inf2015,snowmass_neu2015} which included the outline of the CMB-S4 target. 
